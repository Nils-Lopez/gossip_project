...
ActiveRecord::Schema.define(version: 2020_05_07_134944) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.bigint "gossip_id"
    t.bigint "comment_id"
    t.bigint "commentofcomment_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comment_id"], name: "index_likes_on_comment_id"
    t.index ["commentofcomment_id"], name: "index_likes_on_commentofcomment_id"
